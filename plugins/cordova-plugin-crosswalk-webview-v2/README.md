# cordova-plugin-crosswalk-webview-v2
...
Note that you might have to run `cordova clean` before building, if you previously built the app without cordova-plugin-crosswalk-webview-v2. Also, manually uninstall the app from the device/emulator before attempting to install the crosswalk-enabled version.
