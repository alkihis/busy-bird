...
const PROPERTIES_INTERNAL_NAME = {
    ...
    suggested_not_blank: "suggested_blank",
    range: ".slider-opt-wrapper",
    select_options: ".select-opt-wrapper",
    slider_options: ".slider-opt-wrapper",
    file_type: "file_type",
...
const FORM_PROPERTIES = {
    ...
    suggested_not_blank: generateSuggested,
    range: generateRange,
    select_options: generateSelectOpt,
    slider_options: generateSliderOpt,
    file_type: generateFileType,
    precision: generateFloatPrec,
