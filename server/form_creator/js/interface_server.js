...
function toolbox(modal) {
    ...
    document.getElementById('__make_user_admin').onclick = async () => {
        const username = document.getElementById('usrn_to_make');
        const status = document.getElementById('status_to_make');
        const admin_p = document.getElementById('pass_to_make');
    ...
    document.getElementById('__chg_password').onclick = async () => {
        const old = document.getElementById('__old_psw');
        const newone = document.getElementById('__new_psw');
        const repeat = document.getElementById('__new_psw2');
